"""
Django settings for navigator_41796 project.
...
ROOT_URLCONF = 'navigator_41796.urls'
...
WSGI_APPLICATION = 'navigator_41796.wsgi.application'
...
SPECTACULAR_SETTINGS = {
    ...
    "TITLE": "navigator_41796 API",
    "DESCRIPTION": "API documentation for navigator_41796 App",
    "VERSION": "v1",
}
